        ...
        <CardContent>
          <div className="space-y-4">
            ...
            <Button
              ...
              disabled={uploadId !== "" || uploading || deployed} // Disable after deployment
              className="w-full"
              type="submit"
            >
              {deployed
                ? `Deployed (${uploadId})` // Change to "Deployed" after deployment
                : uploadId
                ? `Deploying (${uploadId})`
                : uploading
                ? "Uploading..."
          ...
          <CardContent>
            <div className="space-y-2">
              ...
              <Input
                ...
                readOnly
                type="url"
                value={`http://${uploadId}.replitx.net:3001/index.html`}
              />
            </div>
            <br />
            <Button className="w-full" variant="outline">
              <a
                href={`http://${uploadId}.replitx.net:3001/index.html`}
                target="_blank"
              >
                Visit Website
              </a>
